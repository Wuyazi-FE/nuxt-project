...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-c33937e0.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/dashboard-98b8aacb.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-76544dc9.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/login-4269e279.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/_id_-7478abce.js").then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-edc956f5.js")
};
...
const layouts = {
  default: () => import("./_nuxt/default-b3e97a6c.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-50f3155a.js").then((r) => r.default || r));
